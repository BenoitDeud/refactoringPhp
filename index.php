...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-item nav-link" href="../views/post.php">contact</a>
                <a class="nav-item nav-link" href="../admin/indexAdmin.php">blog</a>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <?php require_once "include/trucadroite.php"?>
